<template>
  <header
    class="header h-28 w-full  z-30 bg-white py-0 px-16 flex justify-between items-center border-b-2 border-green-800 shadow-md"
  >
    <router-link
      :to="{ name: 'Home' }"
      id="siteLogoName"
    ...
    >
      <div class=" w-9 lg:w-16 ">
        <img class=" object-fill   " src="@/assets/world.png" alt="logo" />
      </div>
      <span
        class="pl-4 text-2xl lg:text-4xl xl:text-4xl text-gray-900 lg:font-normal font-medium "
    ...
    <nav>
      <div class="p-6 flex items-center justify-between" id="nav">
        ...
        <router-link
          v-if="userIsLoggedIn"
          to="/new"
          class=" text-gray-700 rounded p-3  border-green-700"
        >
          <div class="flex items-end">
        ...
        <a
          @click="toggleModal"
          v-if="!userIsLoggedIn"
          class=" text-gray-700 bg-green-700 p-3 rounded"
        >
    ...
    >
      <div class="flex flex-col items-end">
        ...
        <a
          @click="toggleModal"
          v-if="!userIsLoggedIn"
          class=" text-gray-700 bg-green-700 p-3 rounded hover:text-green-800 mt-4"
        >
        ...
        <a
          @click="logout"
          v-if="userIsLoggedIn"
          class=" text-gray-700 bg-green-700 p-3 rounded mt-6"
        >
          <div class="flex items-end text-white">
            <span class="mx-3 ">Logout</span>
